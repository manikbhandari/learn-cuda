...
__global__ void gpu_convolution(const float* matrix_1_d, unsigned int numRows_1, unsigned int numCols_1, 
                                const float* matrix_2_d, unsigned int numRows_2, unsigned int numCols_2, 
                                float* matrix_ans_d) {
}

int main() {
    unsigned int numRows_1 = 5;
    unsigned int numCols_1 = 5;
    unsigned int numRows_2 = 4;
    ...
    gpu_convolution <<< numBlocksPerThread, numThreadsPerBlock >>> (matrix_1_d, numRows_1, numCols_1, 
                                                                    matrix_2_d, numRows_2, numCols_2, matrix_ans_d);
